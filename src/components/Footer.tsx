    ...
    <footer className="bg-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <h4 className="text-gray-500 uppercase text-sm font-medium tracking-wider mb-6">
              EXPLORE FEATURES
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-600 hover:text-primary inline-flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-600 hover:text-primary inline-flex items-center">
                  <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 18L21 13.5V6.5L12 11L3 6.5V13.5L12 18Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M12 22V18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M21 6.5L12 2L3 6.5L12 11L21 6.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
